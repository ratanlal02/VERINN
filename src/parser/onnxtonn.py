...
from src.utilities.parseruts import ParserUTS
...
class ONNX(Parser, ABC):
    ...
    def __init__(self, strFilePath: str):
        ...
        self.__dictWeight__: Dict[int, npt.ArrayLike] = self.__dictWeight__(W)
        self.__dictBias__: Dict[int, npt.ArrayLike] = self.__dictBias__(b)
    ...
    def getNetwork(self) -> GNN:
        ...
        return ParserUTS.toStandardGNN(self.__dictNeurons__, self.__dictWeight__, self.__dictBias__)
